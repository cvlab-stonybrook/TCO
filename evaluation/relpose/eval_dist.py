...
from ttt3r.models.ttt3r_vggt_lora import TTT3R_VGGT_LoRA
from base_models.vggt.vggt import VGGT
from base_models.pi3.pi3 import Pi3
from ttt3r.utils.interfaces import infer_cameras_c2w
from ttt3r.utils.files import list_imgs_a_sequence, list_depths_a_sequence, get_all_sequences
from ttt3r.utils.messages import set_default_arg, write_csv, save_list_of_matrices
...
def main(hydra_cfg: DictConfig):
    ...
    # 0. create model
    model = TTT3R_VGGT_LoRA.from_pretrained(pretrained_model_name_or_path).to(hydra_cfg.device).eval()
